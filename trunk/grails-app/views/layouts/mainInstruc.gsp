...
<g:link controller="proyecto" action="proyectoUser" onMouseOver="xpe('77xq7o');" onMouseOut="xpe('77xq7n');" onMouseDown="xpe('77xq7c');"><img  src="${resource(dir:'images/Instructor-files',file:'bt77xq7_0.gif')}" id="xpi_77xq7" name="vb77xq7" width="130" height="40" border="0" alt="Proyecto"/></g:link></td>
<td style="padding-right:20px" title ="Trabajadores">
<g:link controller="user" action="createWorker" onMouseOver="xpe('q7xq7o');" onMouseOut="xpe('q7xq7n');" onMouseDown="xpe('q7xq7c');"><img  src="${resource(dir:'images/Instructor-files',file:'btq7xq7_0.gif')}"id="xpi_q7xq7" name="vbq7xq7" width="130" height="40" border="0" alt="Trabajadores"/></g:link></td>
<td style="padding-right:20px" title ="Reportes">
<g:link controller="user" action="reportWorker" onMouseOver="xpe('m7xq7o');" onMouseOut="xpe('m7xq7n');" onMouseDown="xpe('m7xq7c');"><img  src="${resource(dir:'images/Instructor-files',file:'btm7xq7_0.gif')}" id="xpi_m7xq7" name="vbm7xq7" width="130" height="40" border="0" alt="Reportes"/></g:link></td>
<td style="padding-right:5px" title ="Cerrar Sesion">
<g:link controller="login" action="logout" onMouseOver="xpe('57xq7o');" onMouseOut="xpe('57xq7n');" onMouseDown="xpe('57xq7c');"><img src="${resource(dir:'images/Instructor-files',file:'bt57xq7_0.gif')}" id="xpi_57xq7" name="vb57xq7" width="130" height="40" border="0" alt="Cerrar Sesion"/></g:link></td>
</tr></table></div>
