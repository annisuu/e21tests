...
<table id="vista-buttons.com:id77xq7" width=0 cellpadding=0 cellspacing=0 border=0><tr>
 ...
 <a href="../gestor de test" onMouseOver='xpe("q7xq7o");' onMouseOut='xpe("q7xq7n");' onMouseDown='xpe("q7xq7c");'><img src="${resource(dir:'images/Instructor-files',file:'btq7xq7_0.gif')}" id="xpi_q7xq7" name="vbq7xq7" width="135" height="44" border="0" alt="Gestor de Test"/></a></td>
 <td style="padding-right:20px" title ="Cerrar Sesion">
 <a href="../cerrar sesion" onMouseOver='xpe("m7xq7o");' onMouseOut='xpe("m7xq7n");' onMouseDown='xpe("m7xq7c");'><img src="${resource(dir:'images/Instructor-files',file:'btm7xq7_0.gif ')}" id="xpi_m7xq7" name="vbm7xq7" width="135" height="44" border="0" alt="Cerrar Sesion"/></a></td>
</tr></table>
...
<a href="../modificar test"onMouseOver='xpe("a53h1o");' onMouseOut='xpe("a53h1n");' onMouseDown='xpe("a53h1c");'><img id="xpi_a53h1" src="${resource(dir:'images/Instructor-files',file:'bta53h1_0.gif')}" name="vba53h1" width="150" height="35" border="0" alt="MODIFICAR TEST"/></a></td></tr></table>
